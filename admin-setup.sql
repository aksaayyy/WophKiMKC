-- Admin System Setup - Run this in Supabase SQL Editor
...
VALUES (
  'info',
  'Admin System Ready',
  'The admin system has been successfully set up. You can now manage users, jobs, and system settings.',
  NOW() + INTERVAL '7 days'
);

-- Success message
SELECT 'Admin system setup complete! Create a user with email containing "admin" to access /admin' as message;