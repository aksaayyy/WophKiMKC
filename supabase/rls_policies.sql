-- Row Level Security (RLS) Policies for Video Clipper Pro
-- These policies ensure users can only access their own data and team data they have permission to view
